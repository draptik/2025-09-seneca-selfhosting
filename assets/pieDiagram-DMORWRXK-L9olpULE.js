import{p as U}from"./chunk-K2ZEYYM2-W7ijLszk.js";import{p as V}from"./treemap-KMMF4GRG-YVX6V4UE-BPbD2mU0.js";import{a as s,g as Z,s as j,b as q,c as H,v as J,t as K,l as w,d as Q,G as X,a7 as Y,a9 as ee,aa as G,ab as te,f as ae,A as re,ac as ie,I as se}from"./Mermaid.vue_vue_type_script_setup_true_lang-jceVz0Y_.js";import"./chunk-ZZTYOBSU-JD-ciJ6d.js";import"./index-UvsVDWdI.js";import"./modules/vue-DfMStYL2.js";import"./modules/shiki-BeVB6AWy.js";import"./modules/file-saver-B7oFTzqn.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),de=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),pe=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),W={getConfig:ne,clear:ce,setDiagramTitle:K,getDiagramTitle:J,setAccTitle:H,getAccTitle:q,setAccDescription:j,getAccDescription:Z,addSection:de,getSections:pe,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await V("pie",e);w.debug(a),fe(a,W)},"parse")},me=s(e=>`
  .pieCircle{
